            ...
            if (null != i) {
                ...
                try {
                    if (((o = (i = i.call(t)).next), 0 === e)) {
                        ...
                        for (
                            ;
                            !(u = (n = o.call(i)).done) && (a.push(n.value), a.length !== e);
                            u = !0
                        );
                } catch (t) {
                    ((l = !0), (r = t));
                    ...
                    try {
                        if (!u && null != i.return && ((s = i.return()), Object(s) !== s))
                            return;
                    } finally {
                        if (l) throw r;
                    }
    ...
    w = (function () {
        function e() {
            var i =
                ...
                a = void 0 === s ? g : s,
                u = i.canvas,
                l = void 0 === u ? this.createCanvas(o, a) : u,
                c = i.ctx,
                h = void 0 === c ? this.createCanvasContext(l) : c,
                f = i.imageData,
                p = void 0 === f ? this.createImageData(l, h, o, a) : f;
            (t(this, e),
                n(this, "hOffset", 0),
                n(this, "vOffset", 0),
                n(this, "keyColor", null),
                n(this, "backgroundContainer", null),
                n(this, "borderColor", null),
                n(this, "memoryColor", null),
                n(this, "clut", new Array(16).fill([0, 0, 0])),
                n(this, "pixels", new Array(A).fill(0)),
                n(this, "buffer", new Array(A).fill(0)),
                (this.canvas = l),
                (this.ctx = h),
                (this.imageData = p));
        }
            ...
            i(e, [
                ...
                },
                {
                    ...
                    value: function (t, e, i, n) {
                        this.clut[t] = [e, i, n].map(function (t) {
                            return 17 * t;
                        });
                    },
                },
                ...
                },
                {
                    ...
                    value: function () {
                        switch (!0) {
                            case null != this.keyColor:
                                return this.keyColor;
                            case null != this.backgroundColor:
                                return this.backgroundColor;
                            case null != this.memoryColor:
                                return this.memoryColor;
                            case null != this.borderColor:
                        ...
                        for (var t = 0; t < 300; t++)
                            for (var e = 0; e < 216; e++) {
                                var i = 4 * (t + e * m),
                                    n =
                                        ((t - this.hOffset + m) % m) +
                                        ((e - this.vOffset + g) % g) * m,
                                    r = this.pixels[n],
                                    o = h(this.clut[r], 3),
                                    s = o[0],
                                    a = o[1],
                                    u = o[2];
                                ((this.imageData.data[i] = s),
                                    (this.imageData.data[i + 1] = a),
                                    (this.imageData.data[i + 2] = u),
                                    (this.imageData.data[i + 3] = r === this.keyColor ? 0 : 255));
                            }
...
function B() {
    var t;
    console && console.warn && (t = console).warn.apply(t, arguments);
}
var x = (function () {
    function e(i) {
        var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0;
        (t(this, e), (this.bytes = i.slice(n, n + 24)));
    }
    return (
        i(e, [
            {
...
(n(x, "instruction", ""), n(x, "opcode", null));
var C = (function (e) {
    r(o, x);
    var n = u(o);
    function o() {
...
(n(C, "instruction", "No-op"), n(C, "opcode", 0));
var P = (function (e) {
    r(o, x);
    var n = u(o);
    function o(e) {
        ...
        var s = r + 4;
        return (
            ((i = n.call(this, e, r)).color = 15 & e[s]),
            (i.repeat = 15 & e[s + 1]),
            i
        );
    }
    return (
        i(o, [
            ...
            },
            {
                key: "detailsToString",
                value: function () {
                    return "color index: ".concat(this.color);
                },
            },
        ]),
        o
...
(n(P, "instruction", "Memory Preset"), n(P, "opcode", 1));
var S = (function (e) {
    r(o, x);
    var n = u(o);
    function o(e) {
        var i,
            r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0;
        return (t(this, o), ((i = n.call(this, e, r)).color = 15 & e[r + 4]), i);
    }
    return (
        i(o, [
            {
                key: "execute",
                value: function (t) {
                    ((t.borderColor = this.color), (t.backgroundColor = this.color));
                    for (
                        var e = h(y, 4), i = e[0], n = e[1], r = e[2], o = e[3], s = 0;
                        s < m;
                        s++
                    ) {
                        for (var a = 0; a < n; a++) t.setPixel(s, a, this.color);
                        for (var u = o + 1; u < g; u++) t.setPixel(s, u, this.color);
                    }
                    for (var l = n; l <= o; l++) {
                        for (var c = 0; c < i; c++) t.setPixel(c, l, this.color);
                        for (var f = r + 1; f < m; f++) t.setPixel(f, l, this.color);
                    }
                },
            },
            {
...
(n(S, "instruction", "Border Preset"), n(S, "opcode", 2));
var _ = (function (e) {
    r(o, x);
    var n = u(o);
    function o(e) {
        ...
        var s = r + 4;
        return (
            ((i = n.call(this, e, r)).colors = [15 & e[s], 15 & e[s + 1]]),
            (i.row = 31 & e[s + 2]),
            (i.column = 63 & e[s + 3]),
            (i.pixels = e.slice(s + 4, s + 16)),
            i
        );
    }
    return (
        i(o, [
            {
                ...
                value: function (t) {
                    ...
                    if (e + 6 > m || i + v > g)
                        B(
                            "TileBlock out of bounds ("
                                .concat(this.row, ", ")
                                .concat(this.column, ")"),
                        );
                    else
                        for (var n = 0; n < v; n++)
                            for (var r = this.pixels[n], o = 0; o < 6; o++) {
                                var s = this.colors[(r >> (5 - o)) & 1];
                                this.op(t, e + o, i + n, s);
                            }
                },
            },
            ...
            },
            {
                ...
                value: function () {
                    return "row: "
                        .concat(this.row, ", column: ")
                        .concat(this.column, ", color indexes: [")
                        .concat(this.colors.join(", "), "]");
                },
            },
        ]),
        o
...
(n(_, "instruction", "Tile Block"), n(_, "opcode", 6));
var L = (function (e) {
    r(o, _);
    var n = u(o);
    function o() {
        ...
        i(o, [
            {
                key: "op",
                value: function (t, e, i, n) {
                    t.setPixel(e, i, t.getPixel(e, i) ^ n);
                },
            },
        ]),
        o
...
(n(L, "instruction", "Tile Block (XOR)"), n(L, "opcode", 38));
var I = (function (e) {
    r(o, x);
    var n = u(o);
    function o(e) {
        ...
        (i = n.call(this, e, r)).color = 15 & e[s];
        var a = 63 & e[s + 1];
        ((i.hCmd = (48 & a) >> 4), (i.hOffset = 7 & a));
        var u = 63 & e[s + 2];
        return ((i.vCmd = (48 & u) >> 4), (i.vOffset = 15 & u), i);
    }
    return (
        i(o, [
            {
                ...
                value: function (t) {
                    ((t.backgroundColor = this.color),
                        (t.hOffset = Math.min(this.hOffset, 5)),
                        (t.vOffset = Math.min(this.vOffset, 11)));
                    var e = 0;
                    switch (this.hCmd) {
                        case 2:
                            e = 6;
                    ...
                    if (e || i) {
                        for (var n = 0; n < m; n++)
                            for (var r = 0; r < g; r++)
                                t.buffer[n + r * m] = this.getPixel(t, n + e, r + i);
                        var o = [t.buffer, t.pixels];
                        ((t.pixels = o[0]), (t.buffer = o[1]));
                    }
                },
            },
            {
            ...
            },
            {
                ...
                value: function () {
                    var t = !1,
                        e = !1;
                    return (
                        1 === this.vCmd ? (t = "up") : 2 === this.vCmd && (t = "down"),
                        1 === this.vCmd ? (e = "left") : 2 === this.vCmd && (e = "right"),
                        [
                            t,
                            e,
                            "vOffset: ".concat(this.vOffset),
                            "hOffset: ".concat(this.hOffset),
                        ]
                            .filter(function (t) {
                                return t;
                            })
...
(n(I, "instruction", "Scroll Preset"), n(I, "opcode", 20));
var E = (function (e) {
    r(o, I);
    var n = u(o);
    function o() {
        ...
        i(o, [
            {
                key: "getPixel",
                value: function (t, e, i) {
                    return ((e = (e + m) % m), (i = (i + g) % g), t.pixels[e + i * m]);
                },
            },
        ]),
        o
...
(n(E, "instruction", "Scroll Copy"), n(E, "opcode", 24));
var O = (function (e) {
    r(o, x);
    var n = u(o);
    function o(e) {
...
(n(O, "instruction", "Set Key Color"), n(O, "opcode", 28));
var R = (function (e) {
    r(o, x);
    var n = u(o);
    function o(e) {
        ...
        t(this, o);
        var s = r + 4;
        (i = n.call(this, e, r)).colors = [];
        for (var a = 0; a < 8; a++) {
            var u = s + 2 * a,
                l = ((63 & e[u]) << 6) + (63 & e[u + 1]);
            i.colors[a] = [l >> 8, (240 & l) >> 4, 15 & l];
        }
        return i;
    }
    return (
            ...
            },
            {
                ...
                value: function () {
                    ...
                    return "colors: [".concat(
                        this.colors
                            .map(function (e, i) {
                                return "".concat(i + t.clutOffset, ": #").concat(
                                    e
                                        .map(function (t) {
...
(n(R, "instruction", "Load CLUT (Low)"), n(R, "opcode", 30));
var T = (function (e) {
    r(o, R);
    var n = u(o);
    function o() {
...
(n(T, "instruction", "Load CLUT (High)"), n(T, "opcode", 31));
var j = (function () {
    function e() {
        (t(this, e),
            n(
                this,
                "instructionClassByType",
                this.constructor.instructionClassByType,
            ));
    }
    return (
        i(
            ...
            [
                {
                    key: "registerInstruction",
                    value: function (t, e) {
                        this.instructionClassByType[t] = e;
                    },
                },
                {
                    ...
                    value: function (t, e) {
                        var i =
                            arguments.length > 2 && void 0 !== arguments[2]
                                ? arguments[2]
                                : 0;
                        t in this.instructionClassByType ||
                            B("Unknown CDG instruction (instruction = ".concat(t, ")"));
                        var n = this.instructionClassByType[t] || C;
                        return new n(e, i);
                    },
                },
                {
                    ...
                    value: function (t) {
                        ...
                        if (9 === i) {
                            var n = 63 & t[e + 1];
                            return this.createInstruction(n, t, e);
                        }
                        return new C(t, e);
                    },
                },
                {
                    ...
                    value: function (t) {
                        for (var e = [], i = t.length, n = 0; n < i; n += 24)
                            e.push(this.parseInstruction(t, n));
...
function M() {
    ...
    if ("undefined" != typeof process && "function" == typeof process.hrtime) {
        var t = h(process.hrtime(), 2);
...
var Y = (function () {
    function e() {
        var i = this,
            ...
            s = void 0 === o ? {} : o,
            a = r.context,
            u = void 0 === a ? this.createContext(s) : a,
            l = r.afterRender;
        (t(this, e),
            n(this, "instructions", []),
            n(this, "pc", -1),
            ...
            n(this, "update", function () {
                var t =
                    arguments.length > 0 && void 0 !== arguments[0]
                        ...
                        : M();
                if (-1 === i.pc) return i;
                ((i.frameId = D(i.update)),
                    i.lastSyncPos
                        ? (i.pos = i.lastSyncPos + (t - i.lastTimestamp))
                        : ((i.pos += t - i.lastTimestamp), (i.lastTimestamp = t)));
                var e = Math.floor((i.pos / 1e3) * 300),
                    n = e - i.pc;
                return (n > 0 && (i.fastForward(n), i.render()), i);
            }),
            (this.context = u),
            (this.afterRender = l));
    }
        ...
        i(e, [
            ...
            },
            {
                ...
                value: function (t) {
                    var e = new j();
                    return (
                        (this.instructions = e.parseInstructions(t)),
                        this.reset(),
                        this
                    );
                },
            ...
            },
            {
                ...
                value: function (t) {
                    return (
                        t && "function" == typeof t.execute && t.execute(this.context),
                        this
                    );
                },
            },
            {
                ...
                value: function () {
                    return (
                        this.pc >= 0 && this.pc < this.instructions.length
            ...
            },
            {
                ...
                value: function () {
                    return (
                        this.frameId ||
                        ((this.frameId = D(this.update)), (this.lastTimestamp = M())),
                        this
                    );
                },
            },
            ...
            },
            {
                key: "sync",
                value: function (t) {
                    return ((this.lastSyncPos = t), (this.lastTimestamp = M()), this);
                },
            },
        ]),
        e
    ...
    F = function () {
        return "undefined" != typeof Promise && Promise.defer
            ? Promise.defer()
            : "undefined" != typeof PromiseUtils && PromiseUtils.defer
                ? PromiseUtils.defer()
                : ((this.resolve = null),
                    (this.reject = null),
    ...
    H = function (t) {
        return JSZip.loadAsync(t).catch(function (t) {
            return Promise.reject(
                new Error("There was an error reading the zip file.", t),
            );
        });
    },
    z = function (t) {
        var e = t.filter(function (t) {
            return t.endsWith(".cdg") || t.endsWith(".mp3");
        });
        return 2 === e.length
            ? Promise.resolve(e)
            : Promise.reject("The file is not a karaoke .zip file");
    },
    q = function (t) {
        var e = t.filter(function (t) {
            return t.name.endsWith(".mp3");
        }),
            i = t.filter(function (t) {
                return t.name.endsWith(".cdg");
            }),
            n = [];
        if (e.length && i.length)
            return (
                n.push(
                    e[0].async("arraybuffer").catch(function () {
                        return Promise.reject(new Error("Unable to load the audio file"));
                    }),
                ),
                n.push(
                    (function (t) {
                        return t.async("uint8array").catch(function () {
                            return Promise.reject(new Error("Unable to load the video file"));
                        });
                    })(i[0]),
                ),
                n.push(
                    (function (t) {
                        return t
                                    ...
                                    new jsmediatags.Reader(e)
                                        ...
                                        .read({
                                            ...
                                            onError: function () {
                                                return i(
                                                    ((e = t.name.split(" - ")),
                                                        ((n = { tags: {} }).tags.album = e[0].trim()),
                                                        (n.tags.artist = e[1] ? e[1].trim() : n.tags.album),
                                                        (n.tags.title = e[2] ? e[2].trim() : n.tags.artist),
                                                        n),
                                                );
                                                var e, n;
                                            },
                            ...
                            .catch(function () {
                                return Promise.reject(new Error("Unable to parse tag data"));
                            });
                    })(e[0]),
                ),
                Promise.all(n)
        ...
        var r = [];
        return (
            e.length || r.push("No mp3 audio file present."),
            i.length || r.push("No cdg video file present."),
            Promise.reject(new Error(r.join(" ")))
        );
    },
    N = (function () {
        function e() {
            ...
            i(e, null, [
                {
                    ...
                    value: function (t) {
                        return (function (t) {
                            var e = new F();
                            return (
                                JSZipUtils.getBinaryContent(t, function (i, n) {
                                    i
                                        ? e.reject(
                                            new Error(
                                                "There was an error retrieving ".concat(t),
                                                i,
                                            ),
                                        )
                                        : e.resolve(n);
            ...
            i(e, [
                ...
                },
                {
                    ...
                    value: function (t, e) {
                        ...
                        var o = this.endIndex;
                        (this.vector.set(t.subarray(n, n + r), o), (this._frameCount += i));
                    },
                },
                {
                    key: "putBuffer",
                    value: function (t, e) {
                        var i =
                            arguments.length > 2 && void 0 !== arguments[2]
                                ...
                                : 0;
                        ((e = e || 0),
                            i >= 0 || (i = t.frameCount - e),
                            this.putSamples(t.vector, t.position + e, i));
                    },
                },
                {
                    key: "receive",
                ...
                },
                {
                    ...
                    value: function (t) {
                        var e =
                            ...
                            i = 2 * e,
                            n = this.startIndex;
                        (t.set(this._vector.subarray(n, n + i)), this.receive(e));
                    },
                },
                {
                    key: "extract",
                        ...
                        var e =
                            ...
                            i =
                                arguments.length > 2 && void 0 !== arguments[2]
                                    ? arguments[2]
                                    : 0,
                            n = this.startIndex + 2 * e,
                            r = 2 * i;
                        t.set(this._vector.subarray(n, n + r));
                    },
                },
                {
                    key: "ensureCapacity",
                    value: function () {
                        ...
                        if (this._vector.length < e) {
                            ...
                            (i.set(this._vector.subarray(this.startIndex, this.endIndex)),
                                (this._vector = i),
                                (this._position = 0));
                        } else this.rewind();
                    },
    ...
    W = (function () {
        function e(i) {
            (t(this, e),
                i
                    ? ((this._inputBuffer = new U()), (this._outputBuffer = new U()))
    ...
    Q = (function (e) {
        ...
        function o(e) {
            var i;
            return (t(this, o), (i = n.call(this, e)).reset(), (i._rate = 1), i);
        }
        return (
            i(o, [
                {
                        ...
                        for (
                            ...
                            ((n[r + 2 * s] =
                                ...
                                (n[r + 2 * s + 1] =
                                    ...
                                    this.slopeCount * e[i + 1]),
                                (s += 1),
                                (this.slopeCount += this._rate));
                        if (((this.slopeCount -= 1), 1 !== t))
                            t: for (; ;) {
                                for (; this.slopeCount > 1;)
                                    if (((this.slopeCount -= 1), (o += 1) >= t - 1)) break t;
                                var a = i + 2 * o;
                                ((n[r + 2 * s] =
                                    (1 - this.slopeCount) * e[a] + this.slopeCount * e[a + 2]),
                                    (n[r + 2 * s + 1] =
                                        (1 - this.slopeCount) * e[a + 1] +
                                        this.slopeCount * e[a + 3]),
                                    (s += 1),
                                    (this.slopeCount += this._rate));
                            }
                        return (
                            (this.prevSampleL = e[i + 2 * t - 2]),
                            (this.prevSampleR = e[i + 2 * t - 1]),
                            s
                        );
                    },
                },
                        ...
                        for (
                            var t =
                                arguments.length > 0 && void 0 !== arguments[0]
                                    ? arguments[0]
                                    : 0;
                            this.outputBuffer.frameCount < t;

                        ) {
                            var e = 16384 - this.inputBuffer.frameCount;
                            if (
                                (this.fillInputBuffer(e), this.inputBuffer.frameCount < 16384)
                            )
                                break;
                            this._pipe.process();
                        }
    ...
    Z = (function (e) {
        ...
        function s(e, i) {
            var r,
                o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : J;
            return (
                t(this, s),
                ((r = n.call(this, i)).callback = o),
                (r.sourceSound = e),
            ...
            i(s, [
                ...
                },
                {
                    ...
                    value: function (t) {
                        ...
                        var n = this.outputBufferPosition + i;
                        return (
                            (this.outputBufferPosition = Math.min(this.historyBufferSize, n)),
                            this.outputBuffer.receive(
                                Math.max(n - this.historyBufferSize, 0),
                            ),
                            (this._position += i),
                            i
                        );
                ...
                },
                {
                    key: "clear",
                    value: function () {
                        (c(o(s.prototype), "clear", this).call(this),
        ...
        return (
            i(s, [
                ...
                },
                {
                    ...
                    value: function () {
                        this.midBufferDirty &&
                            ((this.midBufferDirty = !1), (this.midBuffer = null));
                    },
                },
                {
                    key: "setParameters",
                    value: function (t, e, i, n) {
                        (t > 0 && (this.sampleRate = t),
                            n > 0 && (this.overlapMs = n),
                            e > 0
                                ? ((this.sequenceMs = e), (this.autoSeqSetting = !1))
                                : (this.autoSeqSetting = !0),
                            i > 0
                                ? ((this.seekWindowMs = i), (this.autoSeekSetting = !1))
                ...
                },
                {
                    ...
                    set: function (t) {
                        ...
                        ((this._tempo = t),
                            ...
                            (this.skipFract = 0),
                            (e = Math.floor(this.nominalSkip + 0.5)),
                            (this.sampleReq =
                                Math.max(e + this.overlapLength, this.seekWindowLength) +
                                this.seekLength));
                    },
                },
                {
                ...
                },
                {
                    ...
                    value: function () {
                        var t, e;
                        (this.autoSeqSetting &&
                            ((t = 150 + -50 * this._tempo),
                                (t = this.checkLimits(t, 50, 125)),
                                (this.sequenceMs = Math.floor(t + 0.5))),
                            this.autoSeekSetting &&
                            ((e = 28.333333333333332 + K * this._tempo),
                                (e = this.checkLimits(e, 15, 25)),
                                (this.seekWindowMs = Math.floor(e + 0.5))),
                            (this.seekWindowLength = Math.floor(
                                (this.sampleRate * this.sequenceMs) / 1e3,
                            )),
                            (this.seekLength = Math.floor(
                                (this.sampleRate * this.seekWindowMs) / 1e3,
                            )));
                    },
                },
                {
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        for (
                            ...
                            (i = this.calculateCrossCorrelationStereo(
                                2 * n,
                                this.refMidBuffer,
                            )) > e && ((e = i), (t = n));
                        return t;
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        for (
                            ...
                            for (
                                var s = 0;
                                V[o][s] && !((r = n + V[o][s]) >= this.seekLength);
                ...
                },
                {
                    ...
                    value: function () {
                        for (var t, e, i = 0; i < this.overlapLength; i += 1)
                            ((e = i * (this.overlapLength - i)),
                                (t = 2 * i),
                ...
                },
                {
                    ...
                    value: function (t, e) {
                        ...
                        for (var n, r = 0, o = 2, s = 2 * this.overlapLength; o < s; o += 2)
                            r += i[(n = o + t)] * e[o] + i[n + 1] * e[o + 1];
                        return r;
                    },
                },
                {
                ...
                },
                {
                    ...
                    value: function (t) {
                        ...
                        for (
                            ...
                            o,
                            s,
                            a = this._outputBuffer.vector,
                            u = this._outputBuffer.endIndex,
                            l = 0,
                            c = 1 / this.overlapLength;
                            l < this.overlapLength;
                            l += 1
                        )
                            ((n = (this.overlapLength - l) * c),
                                (r = l * c),
                                (o = (i = 2 * l) + t),
                                (a[(s = i + u) + 0] = e[o + 0] * r + this.midBuffer[i + 0] * n),
                                (a[s + 1] = e[o + 1] * r + this.midBuffer[i + 1] * n));
                    },
                },
                {
                    key: "process",
                    value: function () {
                        ...
                        for (; this._inputBuffer.frameCount >= this.sampleReq;) {
                            ((t = this.seekBestOverlapPosition()),
                                ...
                                (e = this.seekWindowLength - 2 * this.overlapLength) > 0 &&
                                this._outputBuffer.putBuffer(
                                    this._inputBuffer,
                                    t + this.overlapLength,
                                    e,
                                ));
                            var n =
                                this._inputBuffer.startIndex +
                                2 * (t + this.seekWindowLength - this.overlapLength);
                            (this.midBuffer.set(
                                this._inputBuffer.vector.subarray(
                                    n,
                                    n + 2 * this.overlapLength,
                                ),
                            ),
                                (this.skipFract += this.nominalSkip),
                                (i = Math.floor(this.skipFract)),
                                (this.skipFract -= i),
                                this._inputBuffer.receive(i));
                        }
                    },
                },
            ]),
    ...
    tt = (function () {
        function e() {
            (t(this, e),
                (this.transposer = new Q(!1)),
                (this.stretch = new X(!1)),
                (this._inputBuffer = new U()),
                (this._intermediateBuffer = new U()),
                (this._outputBuffer = new U()),
                (this._rate = 0),
                (this._tempo = 0),
                (this.virtualPitch = 1),
                (this.virtualRate = 1),
        ...
        return (
            i(e, [
                ...
                },
                {
                    key: "pitchOctaves",
                    set: function (t) {
                        ((this.pitch = Math.exp(0.69314718056 * t)),
                            this.calculateEffectiveRateAndTempo());
                    },
                },
                {
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        ((this._tempo = this.virtualTempo / this.virtualPitch),
                            ...
                            $(this._tempo, t) && (this.stretch.tempo = this._tempo),
                            $(this._rate, e) && (this.transposer.rate = this._rate),
                            this._rate > 1
                                ? this._outputBuffer != this.transposer.outputBuffer &&
                ...
                },
                {
                    ...
                    value: function () {
                        this._rate > 1
                            ? (this.stretch.process(), this.transposer.process())
    ...
    et = (function () {
        function e(i) {
            (t(this, e), (this.buffer = i), (this._position = 0));
        }
        return (
            i(e, [
                {
                ...
                },
                {
                    ...
                    value: function (t) {
                        ...
                        this.position = i;
                        for (
                            var n = this.buffer.getChannelData(0),
                            r = this.dualChannel
                            ...
                            ((t[2 * o] = n[o + i]), (t[2 * o + 1] = r[o + i]));
                        return Math.min(e, n.length - i);
                    },
                },
            ]),
            e
    ...
    it = function (t, e) {
        var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : J,
            n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 4096,
            r = t.createScriptProcessor(n, 2, 2),
        ...
        return (
            (r.onaudioprocess = function (t) {
                var r = t.outputBuffer.getChannelData(0),
                    ...
                    a = e.extract(o, n);
                (i(e.sourcePosition), 0 === a && e.onEnd());
                for (var u = 0; u < a; u++) ((r[u] = o[2 * u]), (s[u] = o[2 * u + 1]));
            }),
            r
        );
    },
        ...
        return ""
            ...
            .concat(
                ((e = parseInt(o)),
                    ...
                    (e += "").length >= (i = 2)
                        ? e
                        : new Array(i - e.length + 1).join(n) + e),
            );
    },
    rt = function (t) {
        var e = this.timePlayed,
            i = this.sampleRate;
        if (
            ((this.sourcePosition = t),
                (this.timePlayed = t / i),
                e !== this.timePlayed)
        ) {
            var n = new CustomEvent("play", {
                detail: {
            ...
            this._node.dispatchEvent(n);
        }
    },
    ot = (function () {
        function e(i, n, r) {
            var o = this,
                s = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : J;
            (t(this, e), (this._soundtouch = new tt()));
            var a = new et(n);
            ((this.timePlayed = 0),
                (this.sourcePosition = 0),
                (this._filter = new Z(a, this._soundtouch, s)),
                (this._node = it(
                    i,
                    this._filter,
                    function (t) {
            ...
            i(e, [
                {
                    ...
                    get: function () {
                        return nt(this.duration);
                    },
                },
                {
                    key: "formattedTimePlayed",
                    get: function () {
                        return nt(this.timePlayed);
                    },
                },
                {
            ...
            i(e, [
                {
                    ...
                    value: function (t) {
                        return (
                            (t in this.fns && this.fns[t].length > 0) ||
                            this.fns.any.length > 0
                        );
                    },
                },
                {
                ...
                },
                {
                    ...
                    value: function (t, e, i) {
                        return (
                            this.fns.any
                                .concat(t in this.fns ? this.fns[t] : [])
                                .forEach(function (n) {
                                    return n(e, i, t);
                                }),
                            this
                ...
                },
                {
                    ...
                    value: function (t) {
                        for (var e in this.fns)
                            for (var i = this.fns[e], n = 0; n < i.length; n++)
                                if (i[n] === t) return (i.splice(n, 1), !0);
                        return !1;
                    },
                },
                {
        ...
        var e = new st(),
            i = new Proxy(t, {
                ...
                set: function (t, i, n) {
                    return (
                        t.constructor === Array
                            ? "length" !== i && e.fire("change", n)
                            : e.has(i) && e.fire(i, n, t[i]),
                        (t[i] = n),
                        !0
                    );
                },
    ...
    ct = function (t) {
        var e = this;
        return (
            this.shifter && this.shifter.off(),
            this.audio
                .decodeAudioData(t)
                .then(function (t) {
                    ((e.shifter = at(
                        new ot(e.audio, t, 1024, function () {
                            e.stop();
                        }),
                    )),
                        e.shifter.on("play", function (t) {
                            ((e.props.timePlayed = t.formattedTimePlayed),
                                (e.props.percentagePlayed = t.percentagePlayed),
                                e.player.sync(1e3 * t.timePlayed - 800));
                        }),
                        (e.shifter.pitch = 1),
                        (e.props.trackLength = e.shifter.formattedDuration));
                })
                .catch(function (t) {
                    return Promise.reject(
                        new Error("There was an error decoding the audio file", t),
                    );
                })
        );
    },
    ht = function (t) {
        ...
        return (
            t
                ? (this.player.load(Array.from(t)), e.resolve())
                : e.reject(new Error("There was an error loading the video file")),
            e.promise
        );
    },
    ft = function (t, e, i, n, r, o) {
        for (var s = e.split(" "), a = "", u = 0; u < s.length; u++) {
            var l = a + s[u] + " ";
            t.measureText(l).width > r && u > 0
                ? (t.fillText(a.trim(), i, n), (a = s[u] + " "), (n += o))
                : (a = l);
        }
        t.fillText(a.trim(), i, n);
    },
    pt = function () {
        var t = this.ctx,
            e = this.canvas,
        ...
        ((t.font = "30px sans-serif"),
            (t.fillStyle = "#fff"),
            (t.textAlign = "center"),
            ft(t, this.tag.title, n, r, i, 30),
            (t.font = "20px sans-serif"),
            (r = e.height - 60),
            ft(t, "by ".concat(this.tag.artist), n, r, i, 30));
    },
    dt = function (t) {
        if (((this.tag = t && t.tags), this.tag)) return pt.call(this);
    },
    vt = function (t) {
        var e = this,
            i = [];
        return (
            i.push(ct.call(this, t[0])),
            i.push(ht.call(this, t[1])),
            Promise.all(i)
                .then(function () {
                    ((e.props.status = "File Loaded"),
                        (e.props.loaded = !0),
                        dt.call(e, t[2]));
                })
                .catch(function (t) {
                    return ((e.props.status = "File Loading Failed"), Promise.reject(t));
                })
                .then(function () {
                    e.props.loading = !1;
                })
    ...
    gt = (function () {
        function e(i) {
            ...
            if (
                ...
                throw new Error(
                    'CDGPlayer: and element was not found with the "'.concat(
                        i,
                        '" selector',
                    ),
                );
            ...
            (u.classList.add("titleImage"),
                this.wrapper.appendChild(u),
                (this.onloaded = this.props.on("loaded", function (t) {
                    t ? u.classList.add("hide") : u.classList.remove("hide");
                })),
                (this.audio = new (window.AudioContext || window.webkitAudioContext)()),
                (this.gainNode = this.audio.createGain()),
                (this.onvolume = this.props.on("songVolume", function (t) {
                    mt.call(a, t);
                })),
                (this.props.songVolume = 1));
        }
        return (
            i(e, [
                {
                ...
                },
                {
                    ...
                    value: function (t) {
                        ...
                        if (
                            (this.stop(),
                                lt(this.ctx, this.canvas),
                                (this.props.loading = !0),
                                "string" == typeof t)
                        ) {
                            if (!t.toLowerCase().endsWith(".zip"))
                                return (
                                    (this.props.loading = !1),
                                    (this.props.status = "".concat(
                                        t,
                                        ' doesn\'t appear to be a ".zip" file.',
                                    )),
                                    Promise.reject(this.props.status)
                                );
                            ((this.props.status = "Retrieving File..."),
                                (e = N.loadZipFile(t)));
                        } else
                            ((this.props.status = "Loading File..."),
                                (e = N.loadFileBuffer(t)));
                        return e
                            .then(function (t) {
                                return vt.call(i, t);
                            })
                ...
                },
                {
                    key: "togglePlay",
                    value: function () {
                        this.props.isPlaying ? this.pause() : this.start();
                    },
                },
                {
                    key: "start",
                ...
                },
                {
                    ...
                    value: function () {
                        this.shifter &&
                            (this.pause(), this.changePlayerPosition(0), pt.call(this));
                    },
                },
                {
                ...
                },
                {
                    key: "volume",
                    value: function (t) {
                        var e = +(this.gainNode.gain.value + t).toFixed(2);
                        this.props.songVolume = e < 0 ? 0 : e > 1 ? 1 : e;
                    },
                },
                {
                    key: "toggleMute",
                    value: function () {
                        var t = this.gainNode.gain.value;
                        ((this.props.songVolume = t ? 0 : this.fallbackVolume),
                            (this.fallbackVolume = t));
                    },
                },
            ]),
            e
...
var At = "icofont-play-alt-1",
    ...
    wt = function () {
        var t = this,
            e = this.player.props;
        ((this.onloaded = e.on("loaded", function (e) {
            e
                ? (t.playBtn.removeAttribute("disabled"),
                    t.pitch.removeAttribute("disabled"),
                    t.volumeBtn.removeAttribute("disabled"))
                : (t.playBtn.setAttribute("disabled", "disabled"),
                    t.pitch.setAttribute("disabled", "disabled"),
                    t.volumeBtn.setAttribute("disabled", "disabled"));
        })),
            (this.ontimeplayed = e.on("timePlayed", function (e, i) {
                e !== i && (t.timePlayed.innerHTML = e);
            })),
            (this.onpercentageplayed = e.on("percentagePlayed", function (e, i) {
                e !== i && (t.progress.value = e);
            })),
            (this.ontracklength = e.on("trackLength", function (e, i) {
                e !== i && (t.trackLength.innerHTML = e);
            })),
            (this.ondestroy = e.on("destroy", function (e) {
                e && Bt.call(t);
            })),
            (this.onplay = e.on("isPlaying", function (e) {
                (t.playIcn.classList.remove(At, kt),
                    t.playIcn.classList.add(e ? kt : At));
            })),
            (this.onvolume = e.on("songVolume", function (e) {
                var i = t.volumeIcn;
                if (((t.volumeSlider.value = e), e))
                    return i.classList.contains("mute")
                        ? void i.classList.remove("mute")
                        : void 0;
            ...
            this.pitch.addEventListener("change", function () {
                return Ct.call(t);
            }),
    ...
    Bt = function () {
        var t = this,
            e = this.player.props;
        (e.off(this.onloaded),
            e.off(this.ontimeplayed),
            e.off(this.onpercentageplayed),
            e.off(this.ontracklength),
            e.off(this.ondestroy),
            e.off(this.onplay),
            e.off(this.onvolume),
            this.playBtn.removeEventListener("click", function () {
                return t.player.togglePlay();
            }),
            this.progress.removeEventListener("click", function (e) {
                return xt.call(t, e);
            }),
            this.pitch.removeEventListener("change", function () {
                return Ct.call(t);
            }),
            this.volumeSlider.removeEventListener("change", function () {
                return Pt.call(t);
            }));
    },
    xt = function (t) {
        var e = t.target.getBoundingClientRect(),
            i = (t.pageX - e.x) / t.target.offsetWidth;
        this.player.changePlayerPosition(i);
    },
    Ct = function () {
        var t = this.pitch.value;
        isNaN(t)
            ? (this.pitch.value = this.fallbackPitch)
            : ((this.fallbackPitch = t < -7 ? -7 : t > 7 ? 7 : t),
                this.player.changeKey(this.fallbackPitch));
    },
    Pt = function () {
        this.player.props.songVolume = +(
            parseFloat(this.volumeSlider.value) + 0
        ).toFixed(2);
    },
    St = i(function e(i, r) {
        var o =
            arguments.length > 2 && void 0 !== arguments[2]
                ...
                : { position: "bottom" };
        (t(this, e),
            n(this, "controls", bt(yt)),
            n(this, "player", null),
            n(this, "playBtn", null),
            n(this, "playIcn", null),
            n(this, "timePlayed", null),
            n(this, "progress", null),
            n(this, "trackLength", null),
            n(this, "pitch", null));
        var s = document.querySelector(i);
        (s.appendChild(this.controls), (this.player = r));
        var a = this.player.props;
        if (
        ...
        if (
            ((this.volumeBtn = this.controls.querySelector("#song_volume_button")),
                ...
                (this.volumeSlider.value = a.songVolume),
                "top" === o.position)
        ) {
            var u = this.controls.querySelector(".volumeSlider");
            u.classList.add("under");
        }
        wt.call(this);
    });
export { St as CDGControls, gt as CDGPlayer };
